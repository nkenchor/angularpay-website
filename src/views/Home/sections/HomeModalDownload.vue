        ...
        <div class="min-h-screen px-4 text-center">
          ...
          >
            ...
            >
              ...
              <div class="mt-2">
                <div
                  class="flex flex-col xl:flex-row items-center justify-end px-12 py-16 gap-8"
                >
                  <div class="modal-left text-3xl xl:w-1/2 order-2 xl:order-1">
                    <div class="text-secondary">Download the</div>
                    ...
                    <div class="flex items-center justify-start gap-3 mt-4">
                      ...
                      <div class="w-1/2_">
                        <img
                          src="/img/badges/apple-app-store-badge.svg"
                          alt=""
                          class="h-[50px] w-auto"
                        />
                      </div>
...
const props = withDefaults(defineProps<Props>(), {
  buttonName: "Download",
  icon: "mdi mdi-tray-arrow-down mr-1",
